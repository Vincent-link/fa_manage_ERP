class MemberApi < Grape::API
  resource :organizations do
    resource ':id' do
      ...
      params do
        optional :id, as: :organization_id, type: Integer, desc: '机构id'
  ...
  resource :members do
    ...
    get :news_feeds do
      ...
      p_v_ids = PaperTrail::Version.pluck(:id).sort.reverse
      ...
      present result.last(params[:per_page]), with: Entities::NewsFeeds
    end
    ...
    resource ':id' do
      ...
      get :track_logs do
        ...
        track_logs = member.track_logs.order(updated_at: :desc)
