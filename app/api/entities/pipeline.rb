module Entities
  class Pipeline < Base
    ...
    expose :est_amount, documentation: {type: 'float', desc: '预期融资金额'}
    expose :est_amount_currency, documentation: {type: 'integer', desc: '预期融资金额币种'}
    expose :fee_rate, documentation: {type: 'float', desc: '费率'}
    expose :other_amount, documentation: {type: 'float', desc: '其他金额'}
    expose :complete_rate, documentation: {type: 'float', desc: '年内完成概率'}
    expose :total_fee, documentation: {type: 'float', desc: '项目总收入预测'}
    expose :total_fee_currency, documentation: {type: 'integer', desc: '收入币种'}
    expose :currency_rate, documentation: {type: 'float', desc: '汇率'}
    ...
    expose :success_fee, documentation: {type: 'float', desc: '成功费'}
