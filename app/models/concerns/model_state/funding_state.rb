  ...
  module FundingState
    ...
    included do
      state_config :categroy, config: {
          pp:       {value: 1, desc: 'PP', code: [:category, :company_id, :round_id, :currency_id, :target_amount,
          ...
          ma:       {value: 2, desc: 'M&A', code: [:category, :company_id, :round_id, :currency_id, :target_amount,
                                                   :share, :shiny_word, :com_desc, :products_and_business, :financial,
                                                   :operational, :market_competition, :financing_plan, :sources_type,
                                                   :sources_member, :sources_detail, :funding_score, :project_user_ids]},
